		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Event Manager",
									"targetURL": "#zui5eventmzui5eventm-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zui5eventmzui5eventm-display": {
								"semanticObject": "zui5eventmzui5eventm",
								"action": "display",
								"description": "zui5eventm",
								"title": "Event Manager",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zui5eventm.zui5eventm",
									"url": sap.ui.require.toUrl("zui5eventm/zui5eventm")
								}
							}
						}
					}
